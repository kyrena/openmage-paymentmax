...
class Kyrena_Paymentmax_Model_Wrapper_Tpayrefund extends \tpayLibs\src\_class_tpay\Refunds\BasicRefunds {
	...
	public function refundAny($id = null, $amount = null) {
		$this->transactionID = $id;
		return parent::refundAny($amount);
	}
