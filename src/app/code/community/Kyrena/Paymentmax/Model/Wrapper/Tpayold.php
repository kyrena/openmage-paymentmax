...
class Kyrena_Paymentmax_Model_Wrapper_Tpayold extends \tpayLibs\src\_class_tpay\PaymentForms\PaymentBasicForms {
	...
	public function create($config) {
		return $this->getTransactionForm($config, true); // true = redirect
	}
